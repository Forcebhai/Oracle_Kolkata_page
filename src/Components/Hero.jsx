  ...
  return (
    <div className="relative w-full min-h-[100vh] bg-white overflow-hidden flex flex-col items-center pt-40 pb-20">
      ...
      <div className="relative z-40 flex flex-col items-center mt-10">
        <h1
          className="text-7xl md:text-8xl text-[#800000] mb-2 tracking-wide font-extrabold"
          style={{ fontFamily: "'Montserrat', sans-serif" }}
        >
          Connect.
        </h1>
        <span className="text-2xl md:text-4xl font-extrabold text-[#ff0000] tracking-widest uppercase">
          <Typewriter
            words={['Collaborate', 'Code', 'Create']}
            loop={0}
            cursor
            cursorStyle='_'
            typeSpeed={50}
